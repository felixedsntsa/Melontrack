            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 transform hover:-translate-y-2 group" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-6 leading-relaxed">Pantau kondisi lahan melon cabang Anda dengan data sensor terintegrasi dan notifikasi langsung saat parameter melebihi batas normal.</p>
                        <div class="flex justify-between items-center">
                            <a href="{{ route('cabang.laporan') }}" class="text-yellow-600 font-medium hover:text-yellow-700 transition-colors flex items-center">
                                Akses Pemantauan
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 transform hover:-translate-y-2 group" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="p-6">
                        <div class="flex items-center mb-6">
                            ...
                            <h3 class="text-xl font-bold text-gray-800">Laporan Panen</h3>
                        </div>
                        <p class="text-gray-600 mb-6 leading-relaxed">Catat dan laporkan hasil panen cabang Anda dengan detail kualitas, kuantitas, dan kondisi buah secara terstruktur.</p>
                        <div class="flex justify-between items-center">
                            <a href="{{ route('cabang.hasilpanen') }}" class="text-green-600 font-medium hover:text-green-700 transition-colors flex items-center">
                                Buat Laporan
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                                </svg>
                            </a>
                            <span class="text-xs px-2 py-1 bg-green-100 text-green-800 rounded-full">Panen Bulanan</span>
                        </div>
                    </div>
                </div>
            </div>
